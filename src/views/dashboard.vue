      ...
      <el-col :span="6">
        <el-card>
          <div class="card-content">
            ...
            <div class="info">
              <p class="subtitle-title">
                咨询会话：{{ aiData.systemOverview?.activeComments || 0 }}
              </p>
              <p class="number">
      ...
      <el-col :span="6">
        <el-card>
          <div class="card-content">
            ...
            <div class="info">
              <p class="subtitle-title">
                平均情绪：{{ aiData.systemOverview?.avgMoodScore || 0 }}/10
              </p>
              <p class="number">
                {{ aiData.systemOverview?.avgMoodScore || 0 }}
              </p>
        ...
        <el-card>
          ...
          <div class="chart-content">
            <div class="consultation-stats">
              <div class="stat-item">
                <div class="stat-label">总咨询会话数</div>
              ...
              <div class="stat-item">
                ...
                <div class="stat-value">
                  {{ aiData.consultationStats?.activeUsers }}
                </div>
              </div>
            </div>
            <div
              ref="consulationChartRef"
...
<script setup>
import { getAnalysisOverview } from '@/api/admin.js'
...
const initEmotionChart = () => {
  ...
  const option = {
    title: {
      ...
      left: 'center',
      top: 10,
      textStyle: { color: '#2d3436', fontSize: 16, fontWeight: 'bold' }
    },
    tooltip: {
      trigger: 'axis',
      borderColor: '#fab1a0',
    ...
    series: [
      {
        name: '平均情绪评分',
        type: 'line',
        data: TrendData.map((i) => i.avgMoodScore),
        smooth: true,
      ...
      },
      {
        name: '记录数量',
        type: 'line',
        data: TrendData.map((i) => i.recordCount),
        smooth: true,
    ...
    series: [
      {
        name: '会话数量',
        type: 'bar',
        data: dailyTrend.map((i) => i.sessionCount),
        barWidth: '40%',
        itemStyle: {
          color: {
            type: 'linear',
      ...
      },
      {
        name: '参与用户数',
        type: 'bar',
        data: dailyTrend.map((i) => i.userCount),
        barWidth: '40%',
        itemStyle: {
          color: {
            type: 'linear',
