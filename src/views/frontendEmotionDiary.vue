    ...
    <div class="content">
      ...
      <div class="diary-card">
        ...
        <div class="form-group">
          <div class="detail-form">情绪触发因素</div>
          <div class="form-label">
            <el-input
              v-model="diaryForm.emotionTriggers"
              type="textarea"
              placeholder="今天发生什么事影响到您的情绪了吗？"
              :rows="3"
              :maxlength="1000"
              show-word-limit
            />
...
<script setup>
import { dayjs, subMenuProps } from 'element-plus'
import { ref, reactive } from 'vue'
import { addEmotionDiary } from '@/api/frontendAdmin'
import likeIcon from '../assets/images/like.png'
const iconUrl = likeIcon
